...
if [ -e "${finalzip_path}" ]; then
    ...
    echo "Uploading"
    scp "${finalzip_path}" "kiam001@frs.sourceforge.net:/home/frs/project/motog5/MintOS/"
    cd MintOS
    make genota
    cd ..
    cd MintOS_ota
...
Download ROM via Sourceforge: ["${zip_name}"]("https://sourceforge.net/projects/motog5/files/MintOS/${zip_name}/download")
