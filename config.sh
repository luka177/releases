...
export ROM="lineage"
export ROM_DIR="${WORKSPACE}/lineage-17.1"
export ROM_VERSION="17.1"
export official="false"
export local_manifest_url="https://raw.githubusercontent.com/luka177/volla_yggdrasil_manifest/main/volla_yggdrasil.xml"
